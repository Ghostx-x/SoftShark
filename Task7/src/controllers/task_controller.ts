...
import {AppErrors, ValidationError} from "../errors/error_class.js";
...
export class TaskController {
    ...
    async createTask(req: Request, res: Response): Promise<void> {
        try {
            ...
            const task = await this.taskModel.create(String(title), Number(project_id), String(status), parsedDueDate,
    ...
    async updateTaskAssign(req: Request, res: Response): Promise<void> {
        try {
